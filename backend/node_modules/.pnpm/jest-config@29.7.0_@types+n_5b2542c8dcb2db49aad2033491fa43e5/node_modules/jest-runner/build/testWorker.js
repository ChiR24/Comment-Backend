'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\micro\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.456\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '2043c85a56b8d8917bf66eBgpNDxtRD1MBDQBaWlUAAVcDUlUF', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/micro/.cursor/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2043c85a56b8d8917bf66eBgpNDxtRD1MBDQBaWlUAAVcDUlUF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
